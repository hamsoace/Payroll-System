        ...
        <tbody className="bg-white divide-y divide-gray-200">
          {payrolls.length > 0 ? payrolls.map((payroll) => (
            <tr key={payroll.id} className="hover:bg-gray-50">
              ...
              <td className="px-6 py-4 whitespace-nowrap text-sm text-green-600">${payroll.grossPay.toFixed(2)}</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm text-red-600">${payroll.totalDeductions.toFixed(2)}</td>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-bold text-blue-700">${payroll.netPay.toFixed(2)}</td>
