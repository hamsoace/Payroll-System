...
import { INITIAL_PAYROLL_STATE } from '../constants';
    ...
    <form onSubmit={handleSubmit}>
      {renderSection('Employee Information',
        <>
          ...
          <Input id="month" name="month" label="Month" value={formData.month} onChange={handleInputChange} required placeholder="e.g., July" />
      ...
      <div className="mt-8 bg-blue-50 p-6 rounded-lg grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
        ...
        <div>
            ...
            <p className="text-3xl font-extrabold text-blue-800">${netPay.toFixed(2)}</p>
        </div>
      </div>
